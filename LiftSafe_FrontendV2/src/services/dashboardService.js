...
// ✅ CORREGIDO: Lee el token guardado por AuthContext (localStorage) con fallback a sessionStorage
const getToken = () => {
  return localStorage.getItem('token') || sessionStorage.getItem('liftsafe_token') || sessionStorage.getItem('token');
};
