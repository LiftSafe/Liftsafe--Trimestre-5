...
def get_usuarios(
    ...
    for row in result:
        ...
        resultado.append({
            ...
            "document": doc,
            # ✅ Campos adicionales (Felipe) para poder editar el usuario sin
            # tener que re-parsear el string "document" combinado.
            "id_rol": row["id_rol"],
            "tipo_documento": row["tipo_documento"] or "CC",
            "documento_identidad": row["documento_identidad"] or "",
            "nit": row["nit"] or "",
